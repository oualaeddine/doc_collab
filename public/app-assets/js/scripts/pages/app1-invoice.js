...
$(function() {
    ...
    var applyChangesBtn = $('.item-details'),
        discount,
        tax1,
        tax2,
        discountInput,
    ...
    $(document).on('click', '.Cost', function(e) {
        ...
        // discount = $('.discount');
        console.log($(this).closest('.repeater-wrapper').find('.item-details').valueOf());
        alert($(this).val())
        console.log($(this).val());

        // console.log($this.closest('.repeater-wrapper').find('.tax-2'));
    ...
    // $(document).on('change', '.item-details', function(e) {

    //     // console.log($(this).closest('.repeater-wrapper').find('.item-details'));
    //     console.log($(this).closest('.repeater-wrapper').find('item-details').indexOf("item-details"));
